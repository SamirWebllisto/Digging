...
class ParticleEmitter {
  ...
  update(dt: any) {
    ...
    if (this.age < this.particleDeathAge) {
      const startIndex: number = Math.round(this.particlesPerSecond * (this.age + 0))
